...
{
    public List<WorldEvent> CountryHistory;
    public List<DiplomaticEvent> GovernmentDiplomaticHistory;
    public List<CulturalEvent> GovernmentCulturalHistory;
    public List<IntelEvent> GovernmentIntelHistory;
    public List<NewsEvent> GovernmentNewsHistory;
    public List<TerroristEvent> GovernmentTerroristHistory;
    public List<UprisingEvent> GovernmentUprisingHistory;
    public List<WorldEvent> GovernmentWorldHistory;
    ...
    public List<Deal> CountryPoliticalDeals;
