...
public class CameraMarquee : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            SelectableUnits = new List<GameObject>(GameObject.FindGameObjectsWithTag("Unit"));
            ...
            if (Physics.Raycast(ray, out hit))
            {
                ...
                //	hit.transform.gameObject.GetComponent<UnitSelect>().isSelected = true;
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            foreach (GameObject unit in SelectableUnits)
            {
                ...
                {
                    //	unit.GetComponent<UnitSelect>().isSelected = false;
