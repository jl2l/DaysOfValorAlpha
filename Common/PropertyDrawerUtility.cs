...
public static class PropertyDrawerUtility
{
    ...
    public static void HelpBox(Rect pos, string message, MessageType type, string manualURL = null)
    {
        ...
        // draw text box
        GUI.TextArea(pos, message, ((type != MessageType.None) ? PropertyDrawerUtility.HelpboxIconTextBoxStyle : PropertyDrawerUtility.HelpboxTextBoxStyle));

        // draw icon
        GUIStyle m_HelpboxIconStyle = null;
        switch (type)
        {
            case MessageType.Error: m_HelpboxIconStyle = PropertyDrawerUtility.HelpboxErrorIconStyle; break;
            case MessageType.Info: m_HelpboxIconStyle = PropertyDrawerUtility.HelpboxInfoIconStyle; break;
            case MessageType.Warning: m_HelpboxIconStyle = PropertyDrawerUtility.HelpboxWarningIconStyle; break;
            case MessageType.None: m_HelpboxIconStyle = PropertyDrawerUtility.HelpboxNoIconStyle; break;
        }
