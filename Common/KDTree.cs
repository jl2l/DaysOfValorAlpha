...
public class KDTreeFree
{

    public KDTreeFree[] lr;
    ...
    public static KDTreeFree MakeFromPoints(params Vector3[] pointss)
    {
    ...
    public static KDTreeFree MakeFromPointsC(params Vector3[] points)
    {
